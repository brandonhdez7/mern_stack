...
class Terms extends Component{
    render(){
        return(
            ...
            <Toolbar/>
            <div>
            <h1><strong><ins>DAILY CONVERSIONS TERMS OF SERVICE</ins></strong></h1>
            <ol>
                <li><b><ins>Who, Why, What</ins></b></li>
                <br/>
                <p>
                    <ins>Who</ins>: TheProffesionalHobo.com is maintained by __________ (“TPH”).   At times TPH may also be referred to as “we”, “us”, or “TheProffesionalHobo.com”.  The person who is viewing or interacting this site we will refer to as “you”, “hey you”, or where appropriate “jerkface” (only if you’re being bad).
                </p>
                <p>
                    <ins>Why</ins>: This Terms of Service Agreement (“Agreement”) is our contract with you, and tells you what you can and can’t do and what we can and can’t do with you.
                </p>
                <p>
                    <ins>What</ins>: TPH is a bad ass blog about bigtime balling bloggers.  It blogs about success, failures (not ours of course), and making money online.  
                    We make $$$$$ by: (1) telling people about some of thing you have told us about yourself (if you have given us permission); (2) telling you about people that have paid us to talk about them; and (3) selling advertising space.  
                    If you’re buying from us, you will PAY for what you order when you order it.  
                    Since we wear the pants around here, its up to us whether we’ll run your ad or not, and like your prom date we may reject you…so try again.
                </p>
                <br/>

                <li><strong><ins>VERY BAD THINGS THAT YOU CANNOT DO</ins></strong></li>
                <br/>
                <p>
                    We want you to like us, we do. But the internet is dangerous, and we don’t like danger spilling over onto our website. So while some of this may seem OBVIOUS, 
                    we have to tell you because sometimes its good to be reminded.  So when using our site we expect the following:
                </p>
                    <ul >
                        <li>
                    ...
                    <br/>
                <p>If you follow the rules, you can stay. If you don’t, we can kick you out, haul your ass to court, or tell the Alphabet boys what you’ve done so they’ll put you under surveillance.  
                Our failure to enforce against one person is not a waiver to enforce our rights at any time for the same or different offenses.</p>
                    

                <li><strong><ins>INTELLECTUAL PROPERTY</ins></strong></li>
                <br/>
                    <p>
                ...
                <li><strong><ins>SURVIVAL OF THE DEAD….AGREEMENT</ins></strong></li>
                <br/>
                    <p>
                ...
                <li><strong><ins>THIRD PARTY SHARING</ins></strong></li>
                <br/>
                    <p>
                ...
                <li><strong><ins>LOUD NOISES</ins></strong></li>
                <br/>
                    <p>
                ...
                <li><strong><ins>MISC THINGS</ins></strong></li>
                <br/>
                    <p>
